...
func TestPrint(t *testing.T) {
	...
	cases := []PrintTestCase{
		...
		},
		{
			...
			ExpectedRows: []string{
				message,
				"/tracerr/error_helper_test.go:17 github.com/LB-Zone/tracerr_test.addFrameC()",
				"/tracerr/error_helper_test.go:13 github.com/LB-Zone/tracerr_test.addFrameB()",
				"/tracerr/error_helper_test.go:9 github.com/LB-Zone/tracerr_test.addFrameA()",
				"/tracerr/print_test.go:26 github.com/LB-Zone/tracerr_test.TestPrint()",
			},
		...
		},
		{
			...
			ExpectedRows: []string{
				message,
				"",
				bold("/tracerr/error_helper_test.go:17 github.com/LB-Zone/tracerr_test.addFrameC()"),
				black("16") + "\tfunc addFrameC(message string) error {",
				red("17\t\treturn tracerr.New(message)"),
				black("18") + "\t}",
				"",
				bold("/tracerr/error_helper_test.go:13 github.com/LB-Zone/tracerr_test.addFrameB()"),
				black("12") + "\tfunc addFrameB(message string) error {",
				red("13\t\treturn addFrameC(message)"),
				black("14") + "\t}",
				"",
				bold("/tracerr/error_helper_test.go:9 github.com/LB-Zone/tracerr_test.addFrameA()"),
				black(" 8") + "\tfunc addFrameA(message string) error {",
				red(" 9\t\treturn addFrameB(message)"),
				black("10") + "\t}",
				"",
				bold("/tracerr/print_test.go:26 github.com/LB-Zone/tracerr_test.TestPrint()"),
